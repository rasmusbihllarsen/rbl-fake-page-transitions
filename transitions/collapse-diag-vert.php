...
<div class="rbl_fake_transitions--collapse_diag-vert fpt_bottom active" style="border-color:<?php echo $transition_secondary_color ?>;border-right-color:transparent;border-top-color:transparent;"></div>
